...
public class EnviroEvents : MonoBehaviour {
	...
	private void Start ()
	{
        ...
        EnviroSkyMgr.instance.OnWeatherChanged += (EnviroWeatherPreset _) =>  WeatherChanged ();
        EnviroSkyMgr.instance.OnSeasonChanged += (EnviroSeasons.Seasons _) => SeasonsChanged ();
        EnviroSkyMgr.instance.OnNightTime += () => NightTime ();
        EnviroSkyMgr.instance.OnDayTime += () => DayTime ();
        EnviroSkyMgr.instance.OnZoneChanged += (EnviroZone _) =>  ZoneChanged ();
	}
