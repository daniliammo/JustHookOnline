...
public class EnviroWeatherPresetCreation {
	...
	{
		var wpreset = ScriptableObject.CreateInstance<EnviroWeatherPreset>();
		...
		var assetPathAndName = AssetDatabase.GenerateUniqueAssetPath (path + "/New " + "Weather Preset" + ".asset");
