...
public static class EnviroProfileCreation
{
    ...
    {
        var profile = ScriptableObject.CreateInstance<EnviroProfile>();
        ...
        var assetPathAndName = AssetDatabase.GenerateUniqueAssetPath(path + "/New " + "Enviro Profile" + ".asset");
    ...
    {
        var defaultProfile = GetDefaultProfile("enviro_internal_default_profile");
    ...
    public static bool UpdateProfile(EnviroProfile profile, string fromV, string toV)
    {
        ...
        var gradientTimes = new List<float>();
