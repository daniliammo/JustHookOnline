...
public class EnviroSkyMgr : MonoBehaviour {
    ...
    public static void CreateManagerInstance()
    {
        if (EnviroSkyMgr.instance == null)
        {
            ...
            var mgr =  mgrObj.AddComponent<EnviroSkyMgr>();
    ...
    {
        var prefab = GetAssetPrefab("Internal_Enviro_HD");
    ...
    {
        var prefab = GetAssetPrefab("Internal_Enviro_HD_VR");
    ...
    {
        var prefab = GetAssetPrefab("Internal_Enviro_LW");
    ...
    {
        var prefab = GetAssetPrefab("Internal_Enviro_LW_MOBILE");
    ...
    public int GetCurrentMonth()
    {
        ...
        if (currentEnviroSkyVersion == EnviroSkyVersion.HD)
        {
            ...
            var result = date.AddYears(EnviroSky.instance.GameTime.Years);
        ...
        {
            var date = new System.DateTime();
            var result = date.AddYears(EnviroSkyLite.instance.GameTime.Years);
    ...
    public System.DateTime GetDateAsDateTime()
    {
        ...
        {
            var date = new System.DateTime();
            var result = date.AddYears(EnviroSky.instance.GameTime.Years-1);
        ...
        {
            var date = new System.DateTime();
            var result = date.AddYears(EnviroSkyLite.instance.GameTime.Years - 1);
