...
public class EnviroVegetationInstance : MonoBehaviour {
	...
	private void Start () 
	{
        ...
        EnviroSkyMgr.instance.OnSeasonChanged += (EnviroSeasons.Seasons _) =>
		{
			SetSeason ();
		};
	...
	private void OnEnable ()
	{
		...
		for (var i = 0; i < GrowStages.Count; i++)
		{
	...
	{
		stay = true;
		var deadObj = Instantiate(DeadPrefab,transform.position,transform.rotation);
	...
	{
		var colliders = currentVegetationObject.GetComponentsInChildren<Collider>();
