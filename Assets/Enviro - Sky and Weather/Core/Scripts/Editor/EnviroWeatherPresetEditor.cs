...
public class EnviroWeatherPresetEditor : Editor {
	...
	private EnviroWeatherPreset myTarget;
    ...
    private SerializedProperty fogMod;
    private SerializedProperty skyMod;
    private SerializedProperty lightMod;
    ...
    public override void OnInspectorGUI ()
	{
        ...
        if (showGeneral) {
			...
			for (var i = 0; i < myTarget.effectSystems.Count; i++) {
