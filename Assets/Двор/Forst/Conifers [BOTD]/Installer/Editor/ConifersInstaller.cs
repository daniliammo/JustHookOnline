...
public class ConifersInstaller : EditorWindow
{
    ...
    private string launcherPath = "Assets/Forst/Conifers [BOTD]/Installer/Editor/LaunchConifersInstaller";

    private string[] supportedPipelines = new string[3]
    {
    ...
    private string[] packagePaths = new string[3]
    {
