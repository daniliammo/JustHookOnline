namespace UnityEngine.AzureSky
{
    ...
    public class AzureSkyRenderController : MonoBehaviour
    {
        ...
        [SerializeField] private Shader m_emptySkyShader;
        [Tooltip("The shader used to render the sky with static clouds.")]
        [SerializeField] private Shader m_staticCloudsShader;
        [Tooltip("The shader used to render the sky with dynamic clouds.")]
        [SerializeField] private Shader m_dynamicCloudsShader;
        [Tooltip("The texture used to render the sun disk.")]
        [SerializeField] private Texture2D m_sunTexture;
        [Tooltip("The texture used to render the moon disk.")]
        [SerializeField] private Texture2D m_moonTexture;
        [Tooltip("The cubemap texture used to render the stars and Milky Way.")]
        [SerializeField] private Cubemap m_starfieldTexture;
        [Tooltip("The texture used to render the dynamic clouds.")]
        [SerializeField] private Texture2D m_dynamicCloudsTexture;
        ...
        {
            var rayleigh = Vector3.one;
            var lambda = new Vector3(wavelengthR, wavelengthG, wavelengthB) * 1e-9f;
        ...
        {
            var x = m_dynamicCloudsDirection.x;
            var z = m_dynamicCloudsDirection.y;
            var dir = Mathf.Lerp(0f, 360f, dynamicCloudsDirection);
            var windSpeed = dynamicCloudsSpeed * 0.05f * Time.deltaTime;
