...
namespace Mirror
{
    ...
    public class PredictedRigidbodyVisual : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            var colliderSize = target.GetComponent<Collider>().bounds.size.magnitude;
            var threshold = colliderSize * teleportDistanceMultiplier;
            var distance = Vector3.Distance(transform.position, targetRigidbody.position);
