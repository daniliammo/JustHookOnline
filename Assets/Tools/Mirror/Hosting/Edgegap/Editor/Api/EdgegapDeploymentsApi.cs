...
namespace Edgegap.Editor.Api
{
    ...
    public class EdgegapDeploymentsApi : EdgegapApiBase
    {
            ...
            CreateDeploymentRequest request)
        {
            ...
            var result = new EdgegapHttpResult<CreateDeploymentResult>(response); // MIRROR CHANGE: 'new()' not supported in Unity 2020
        ...
        public async Task<EdgegapHttpResult<GetDeploymentStatusResult>> GetDeploymentStatusAsync(string requestId)
        {
            ...
            var result = new EdgegapHttpResult<GetDeploymentStatusResult>(response); // MIRROR CHANGE: 'new()' not supported in Unity 2020
        ...
        public async Task<EdgegapHttpResult<StopActiveDeploymentResult>> StopActiveDeploymentAsync(string requestId)
        {
            ...
            var result = new EdgegapHttpResult<StopActiveDeploymentResult>(response); // MIRROR CHANGE: 'new()' not supported in Unity 2020
        ...
        {
            var createResponse = await CreateDeploymentAsync(request);
            ...
            TimeSpan pollInterval)
        {
            ...
            var cts = new CancellationTokenSource (TimeSpan.FromMinutes( // MIRROR CHANGE: 'new()' not supported in Unity 2020
