    ...
    public sealed class NetworkIdentity : MonoBehaviour
    {
        ...
        void DisallowChildNetworkIdentities()
        {
            ...
            if (identities.Length > 1)
            {
                ...
                Debug.LogWarning($"'{name}' has another NetworkIdentity component on '{identities[1].name}'. There should only be one NetworkIdentity, and it must be on the root object. Please remove the other one.", this);
            }
        }
