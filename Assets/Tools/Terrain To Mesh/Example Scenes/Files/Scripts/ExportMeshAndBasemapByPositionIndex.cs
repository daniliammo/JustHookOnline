...
namespace AmazingAssets.TerrainToMesh.Example
{
    ...
    public class ExportMeshAndBasemapByPositionIndex : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            var terrainMesh = terrainData.TerrainToMesh().ExportMesh(vertexCountHorizontal, vertexCountVertical, chunkCountHorizontal, chunkCountVertical, positionX, positionY, true, TerrainToMesh.Normal.CalculateFromMesh);
            ...
            var diffuseTexture = terrainData.TerrainToMesh().ExportBasemapDiffuseTexture(mapsResolution, chunkCountHorizontal, chunkCountVertical, positionX, positionY, exportHoles, false);  //alpha channel will contain holesmap
            var normalTexture = terrainData.TerrainToMesh().ExportBasemapNormalTexture(mapsResolution, chunkCountHorizontal, chunkCountVertical, positionX, positionY, false);
            ...
            var mainTexturePropName = Utilities.GetMaterailPropMainTex();
            var bumpMapPropName = Utilities.GetMaterailPropBumpMap();
            var metallicSmoothnessPropName = Utilities.GetMaterailPropMetallicSmoothnessMap();
