...
namespace AmazingAssets.TerrainToMesh.Example
{
    ...
    public class ExportMeshAndBasemap : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            var diffuseTexture = terrainData.TerrainToMesh().ExportBasemapDiffuseTexture(mapsResolution, exportHoles, false);  //alpha channel will contain holesmap
            var normalTexture = terrainData.TerrainToMesh().ExportBasemapNormalTexture(mapsResolution, false);
